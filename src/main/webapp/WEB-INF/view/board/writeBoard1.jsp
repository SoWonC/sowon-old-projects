	...
	<div class="wrapper">
		...
		<div class="form-container">
			<form>
				...
				<input type="hidden" name="nickname" value="${authUser.nickname}" /> <!-- 세션에서 가져온 사용자 정보를 hidden 필드에 할당 -->
				<input type="hidden" name="id" value="${authUser.id}" /> <!-- 세션에서 가져온 사용자 정보를 hidden 필드에 할당 -->
